...
LCDstatus  equ 0FF2EH           ; Adres do odczytu flagi zajętości (Busy Flag) LCD
LCDcontrol equ 0FF2CH           ; Adres do wysyłania komend sterujących do wyświetlacza
LCDdataWR  equ 0FF2DH           ; Adres do wysyłania znaków ASCII do wyświetlenia

// bajty sterujace LCD, inne dostepne w opisie LCD na stronie WWW
#define  HOME     0x80          // Komenda: powrót kursora na początek 1. linii
#define  INITDISP 0x38          // Komenda: inicjalizacja LCD w trybie 8-bitowym
#define  HOM2     0xc0          // Komenda: przejście kursora na początek 2. linii
#define  LCDON    0x0e          // Komenda: włącz ekran, włącz kursor, wyłącz miganie
#define  CLEAR    0x01          // Komenda: wyczyść całkowicie ekran LCD

// linie klawiatury - sterowanie na port P5
#define LINE_1		0x7f        // Maska aktywująca 1. wiersz klawiatury
#define LINE_2		0xbf        // Maska aktywująca 2. wiersz klawiatury
#define	LINE_3		0xdf        // Maska aktywująca 3. wiersz klawiatury
#define LINE_4		0xef        // Maska aktywująca 4. wiersz klawiatury
#define ALL_LINES	0x0f        // Maska do sprawdzenia wszystkich wierszy
